...
const { cmptStyles, cmptStylesIsolated, cmptScriptsIsolated } = require('./components');
...
function watchFiles () {
  ...
  watch([`${config.src.js}/**/*.{js,ts}`, `!${config.src.js}/vendor/*.{js,ts}`], jsCore);
  watch([`${config.src.components}/**/*.{js,ts}`], cmptScriptsIsolated);
}
